...
public class ListToDo extends AppCompatActivity {
    ...
    RecyclerView rv;
    Adapter adapter;
    ArrayList<AddDatabase> datalist;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_list_to_do);
        //membuat judul menjadi To Do List
        setTitle("To Do List");
        ...
        //untuk menset agar ketika menambah /hapus item pada recycler view ukurannya tidak berubah
    ...
    public void hapusgeser(){
        ...
        ItemTouchHelper.SimpleCallback touchcall = new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT) {
            ...
            public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction) {
                ...
                AddDatabase current = adapter.getData(position);
